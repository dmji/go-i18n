...
Refer to the [documentation](https://pkg.go.dev/github.com/dmji/go-i18n-fork/i18n) and [README](https://github.com/nicksnyder/go-i18n/blob/master/README.md) for guidance.
